...
export CARE_DATASET_ID="${CARE_DATASET_ID:-607}"
ED_DATASET_NAME="${ED_DATASET_NAME:-Dataset601_CARE_CineMyoPS_ED}"
OUTPUT_DATASET_NAME="${OUTPUT_DATASET_NAME:-CARE_CineMyoPS_ScarMyoSearchROI_ED}"
